...
export const metadata = {
  title: "Entrance test, Imtehan",
  description:
    "Pick your school to see the exact Habib entrance test breakdown, DSSE for science and engineering, AHSS for arts, humanities and social sciences.",
};
