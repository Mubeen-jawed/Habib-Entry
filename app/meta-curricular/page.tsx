...
export const metadata = {
  title: "Meta-curricular form guide, Imtehan",
  description:
    "How to fill Habib's meta-curricular form, ranked activities and universal do's and don'ts, split by DSSE and AHSS.",
};
